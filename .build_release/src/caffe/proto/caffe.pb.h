...
class LstmParameter;
class NumpyDataParameter;
class CapSequenceParameter;
class WordvecParameter;
class DataParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional bool force_reshape = 204 [default = false];
  inline bool has_force_reshape() const;
  inline void clear_force_reshape();
  static const int kForceReshapeFieldNumber = 204;
  inline bool force_reshape() const;
  inline void set_force_reshape(bool value);
  ...
  // optional .caffe.HungarianLossParameter hungarian_loss_param = 214;
  inline bool has_hungarian_loss_param() const;
  inline void clear_hungarian_loss_param();
  static const int kHungarianLossParamFieldNumber = 214;
  ...
  // optional .caffe.PyParameter py_param = 203;
  inline bool has_py_param() const;
  inline void clear_py_param();
  static const int kPyParamFieldNumber = 203;
  inline const ::caffe::PyParameter& py_param() const;
  inline ::caffe::PyParameter* mutable_py_param();
  inline ::caffe::PyParameter* release_py_param();
  inline void set_allocated_py_param(::caffe::PyParameter* py_param);
  ...
  // optional .caffe.WordvecParameter wordvec_param = 202;
  inline bool has_wordvec_param() const;
  inline void clear_wordvec_param();
  static const int kWordvecParamFieldNumber = 202;
  inline const ::caffe::WordvecParameter& wordvec_param() const;
  inline ::caffe::WordvecParameter* mutable_wordvec_param();
  inline ::caffe::WordvecParameter* release_wordvec_param();
  inline void set_allocated_wordvec_param(::caffe::WordvecParameter* wordvec_param);
 ...
 private:
  ...
  inline void set_has_phase();
  inline void clear_has_phase();
  inline void set_has_force_reshape();
  inline void clear_has_force_reshape();
  ...
  inline void set_has_py_param();
  inline void clear_has_py_param();
  ...
  inline void set_has_wordvec_param();
  inline void clear_has_wordvec_param();
  ...
  ::caffe::WordvecParameter* wordvec_param_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class RuntimeParameter : public ::google::protobuf::Message {
 public:
  RuntimeParameter();
  virtual ~RuntimeParameter();

  RuntimeParameter(const RuntimeParameter& from);

  inline RuntimeParameter& operator=(const RuntimeParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RuntimeParameter& default_instance();

  void Swap(RuntimeParameter* other);

  // implements Message ----------------------------------------------

  RuntimeParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RuntimeParameter& from);
  void MergeFrom(const RuntimeParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional .caffe.NumpyDataParameter numpy_data_param = 1;
  inline bool has_numpy_data_param() const;
  inline void clear_numpy_data_param();
  static const int kNumpyDataParamFieldNumber = 1;
  inline const ::caffe::NumpyDataParameter& numpy_data_param() const;
  inline ::caffe::NumpyDataParameter* mutable_numpy_data_param();
  inline ::caffe::NumpyDataParameter* release_numpy_data_param();
  inline void set_allocated_numpy_data_param(::caffe::NumpyDataParameter* numpy_data_param);

  // optional .caffe.CapSequenceParameter cap_sequence_param = 2;
  inline bool has_cap_sequence_param() const;
  inline void clear_cap_sequence_param();
  static const int kCapSequenceParamFieldNumber = 2;
  inline const ::caffe::CapSequenceParameter& cap_sequence_param() const;
  inline ::caffe::CapSequenceParameter* mutable_cap_sequence_param();
  inline ::caffe::CapSequenceParameter* release_cap_sequence_param();
  inline void set_allocated_cap_sequence_param(::caffe::CapSequenceParameter* cap_sequence_param);

  // @@protoc_insertion_point(class_scope:caffe.RuntimeParameter)
 private:
  inline void set_has_numpy_data_param();
  inline void clear_has_numpy_data_param();
  inline void set_has_cap_sequence_param();
  inline void clear_has_cap_sequence_param();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::caffe::NumpyDataParameter* numpy_data_param_;
  ::caffe::CapSequenceParameter* cap_sequence_param_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static RuntimeParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class ConcatParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_fast_lstm_concat() const;
  inline void clear_fast_lstm_concat();
  static const int kFastLstmConcatFieldNumber = 3;
  inline bool fast_lstm_concat() const;
  inline void set_fast_lstm_concat(bool value);
 ...
 private:
  ...
  inline void set_has_fast_lstm_concat();
  inline void clear_has_fast_lstm_concat();
...
class LstmParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_num_cells() const;
  inline void clear_num_cells();
  static const int kNumCellsFieldNumber = 1;
  inline ::google::protobuf::uint32 num_cells() const;
  inline void set_num_cells(::google::protobuf::uint32 value);

  // optional .caffe.FillerParameter input_weight_filler = 2;
  inline bool has_input_weight_filler() const;
  inline void clear_input_weight_filler();
  static const int kInputWeightFillerFieldNumber = 2;
  inline const ::caffe::FillerParameter& input_weight_filler() const;
  inline ::caffe::FillerParameter* mutable_input_weight_filler();
  inline ::caffe::FillerParameter* release_input_weight_filler();
  inline void set_allocated_input_weight_filler(::caffe::FillerParameter* input_weight_filler);

  // optional .caffe.FillerParameter input_gate_weight_filler = 3;
  inline bool has_input_gate_weight_filler() const;
  inline void clear_input_gate_weight_filler();
  static const int kInputGateWeightFillerFieldNumber = 3;
  inline const ::caffe::FillerParameter& input_gate_weight_filler() const;
  inline ::caffe::FillerParameter* mutable_input_gate_weight_filler();
  inline ::caffe::FillerParameter* release_input_gate_weight_filler();
  inline void set_allocated_input_gate_weight_filler(::caffe::FillerParameter* input_gate_weight_filler);

  // optional .caffe.FillerParameter forget_gate_weight_filler = 4;
  inline bool has_forget_gate_weight_filler() const;
  inline void clear_forget_gate_weight_filler();
  static const int kForgetGateWeightFillerFieldNumber = 4;
  inline const ::caffe::FillerParameter& forget_gate_weight_filler() const;
  inline ::caffe::FillerParameter* mutable_forget_gate_weight_filler();
  inline ::caffe::FillerParameter* release_forget_gate_weight_filler();
  inline void set_allocated_forget_gate_weight_filler(::caffe::FillerParameter* forget_gate_weight_filler);

  // optional .caffe.FillerParameter output_gate_weight_filler = 5;
  inline bool has_output_gate_weight_filler() const;
  inline void clear_output_gate_weight_filler();
  static const int kOutputGateWeightFillerFieldNumber = 5;
  inline const ::caffe::FillerParameter& output_gate_weight_filler() const;
  inline ::caffe::FillerParameter* mutable_output_gate_weight_filler();
  inline ::caffe::FillerParameter* release_output_gate_weight_filler();
  inline void set_allocated_output_gate_weight_filler(::caffe::FillerParameter* output_gate_weight_filler);

  // @@protoc_insertion_point(class_scope:caffe.LstmParameter)
 private:
  inline void set_has_num_cells();
  inline void clear_has_num_cells();
  inline void set_has_input_weight_filler();
  inline void clear_has_input_weight_filler();
  inline void set_has_input_gate_weight_filler();
  inline void clear_has_input_gate_weight_filler();
  inline void set_has_forget_gate_weight_filler();
  inline void clear_has_forget_gate_weight_filler();
  inline void set_has_output_gate_weight_filler();
  inline void clear_has_output_gate_weight_filler();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::caffe::FillerParameter* input_weight_filler_;
  ::caffe::FillerParameter* input_gate_weight_filler_;
  ::caffe::FillerParameter* forget_gate_weight_filler_;
  ::caffe::FillerParameter* output_gate_weight_filler_;
  ::google::protobuf::uint32 num_cells_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class NumpyDataParameter : public ::google::protobuf::Message {
 public:
  NumpyDataParameter();
  virtual ~NumpyDataParameter();

  NumpyDataParameter(const NumpyDataParameter& from);

  inline NumpyDataParameter& operator=(const NumpyDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const NumpyDataParameter& default_instance();

  void Swap(NumpyDataParameter* other);

  // implements Message ----------------------------------------------

  NumpyDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const NumpyDataParameter& from);
  void MergeFrom(const NumpyDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.NumpyDataParameter)
 private:
  ...
  void InitAsDefaultInstance();
  static NumpyDataParameter* default_instance_;
};
// -------------------------------------------------------------------

class CapSequenceParameter : public ::google::protobuf::Message {
 public:
  CapSequenceParameter();
  virtual ~CapSequenceParameter();

  CapSequenceParameter(const CapSequenceParameter& from);

  inline CapSequenceParameter& operator=(const CapSequenceParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CapSequenceParameter& default_instance();

  void Swap(CapSequenceParameter* other);

  // implements Message ----------------------------------------------

  CapSequenceParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CapSequenceParameter& from);
  void MergeFrom(const CapSequenceParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // repeated uint32 sequence_lengths = 1;
  inline int sequence_lengths_size() const;
  inline void clear_sequence_lengths();
  static const int kSequenceLengthsFieldNumber = 1;
  inline ::google::protobuf::uint32 sequence_lengths(int index) const;
  inline void set_sequence_lengths(int index, ::google::protobuf::uint32 value);
  inline void add_sequence_lengths(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      sequence_lengths() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_sequence_lengths();

  // @@protoc_insertion_point(class_scope:caffe.CapSequenceParameter)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > sequence_lengths_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static CapSequenceParameter* default_instance_;
};
// -------------------------------------------------------------------

class WordvecParameter : public ::google::protobuf::Message {
 public:
  WordvecParameter();
  virtual ~WordvecParameter();

  WordvecParameter(const WordvecParameter& from);

  inline WordvecParameter& operator=(const WordvecParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const WordvecParameter& default_instance();

  void Swap(WordvecParameter* other);

  // implements Message ----------------------------------------------

  WordvecParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const WordvecParameter& from);
  void MergeFrom(const WordvecParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline ::google::protobuf::uint32 dimension() const;
  inline void set_dimension(::google::protobuf::uint32 value);
  ...
  inline ::google::protobuf::uint32 vocab_size() const;
  inline void set_vocab_size(::google::protobuf::uint32 value);
  ...
  // @@protoc_insertion_point(class_scope:caffe.WordvecParameter)
 private:
  ...
  ::google::protobuf::uint32 vocab_size_;
  ::caffe::FillerParameter* weight_filler_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
  ...
  void InitAsDefaultInstance();
  static WordvecParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class InnerProductParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional bool output_4d = 6 [default = false];
  inline bool has_output_4d() const;
  inline void clear_output_4d();
  static const int kOutput4DFieldNumber = 6;
  inline bool output_4d() const;
  inline void set_output_4d(bool value);
 ...
 private:
  ...
  inline void set_has_axis();
  inline void clear_has_axis();
  inline void set_has_output_4d();
  inline void clear_has_output_4d();
...
class ParamShapeParameter : public ::google::protobuf::Message {
 public:
  ParamShapeParameter();
  virtual ~ParamShapeParameter();

  ParamShapeParameter(const ParamShapeParameter& from);

  inline ParamShapeParameter& operator=(const ParamShapeParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ParamShapeParameter& default_instance();

  void Swap(ParamShapeParameter* other);

  // implements Message ----------------------------------------------

  ParamShapeParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ParamShapeParameter& from);
  void MergeFrom(const ParamShapeParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline int dimension_size() const;
  inline void clear_dimension();
  static const int kDimensionFieldNumber = 1;
  inline ::google::protobuf::int32 dimension(int index) const;
  inline void set_dimension(int index, ::google::protobuf::int32 value);
  inline void add_dimension(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
      dimension() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
      mutable_dimension();

  // @@protoc_insertion_point(class_scope:caffe.ParamShapeParameter)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > dimension_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static ParamShapeParameter* default_instance_;
};
// -------------------------------------------------------------------

class PyParameter : public ::google::protobuf::Message {
 public:
  PyParameter();
  virtual ~PyParameter();

  PyParameter(const PyParameter& from);

  inline PyParameter& operator=(const PyParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const PyParameter& default_instance();

  void Swap(PyParameter* other);

  // implements Message ----------------------------------------------

  PyParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const PyParameter& from);
  void MergeFrom(const PyParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // repeated .caffe.ParamShapeParameter param_shapes = 1;
  inline int param_shapes_size() const;
  inline void clear_param_shapes();
  static const int kParamShapesFieldNumber = 1;
  inline const ::caffe::ParamShapeParameter& param_shapes(int index) const;
  inline ::caffe::ParamShapeParameter* mutable_param_shapes(int index);
  inline ::caffe::ParamShapeParameter* add_param_shapes();
  inline const ::google::protobuf::RepeatedPtrField< ::caffe::ParamShapeParameter >&
      param_shapes() const;
  inline ::google::protobuf::RepeatedPtrField< ::caffe::ParamShapeParameter >*
      mutable_param_shapes();

  // repeated .caffe.FillerParameter param_fillers = 2;
  inline int param_fillers_size() const;
  inline void clear_param_fillers();
  static const int kParamFillersFieldNumber = 2;
  inline const ::caffe::FillerParameter& param_fillers(int index) const;
  inline ::caffe::FillerParameter* mutable_param_fillers(int index);
  inline ::caffe::FillerParameter* add_param_fillers();
  inline const ::google::protobuf::RepeatedPtrField< ::caffe::FillerParameter >&
      param_fillers() const;
  inline ::google::protobuf::RepeatedPtrField< ::caffe::FillerParameter >*
      mutable_param_fillers();

  // @@protoc_insertion_point(class_scope:caffe.PyParameter)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::caffe::ParamShapeParameter > param_shapes_;
  ::google::protobuf::RepeatedPtrField< ::caffe::FillerParameter > param_fillers_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static PyParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class SliceParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_fast_wordvec_slice() const;
  inline void clear_fast_wordvec_slice();
  static const int kFastWordvecSliceFieldNumber = 4;
  inline bool fast_wordvec_slice() const;
  inline void set_fast_wordvec_slice(bool value);
 ...
 private:
  inline void set_has_axis();
  inline void clear_has_axis();
  inline void set_has_fast_wordvec_slice();
  inline void clear_has_fast_wordvec_slice();
...
// optional bool force_reshape = 204 [default = false];
inline bool LayerParameter::has_force_reshape() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void LayerParameter::set_has_force_reshape() {
  _has_bits_[0] |= 0x00000800u;
}
inline void LayerParameter::clear_has_force_reshape() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void LayerParameter::clear_force_reshape() {
  force_reshape_ = false;
  clear_has_force_reshape();
}
inline bool LayerParameter::force_reshape() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.force_reshape)
  return force_reshape_;
}
inline void LayerParameter::set_force_reshape(bool value) {
  set_has_force_reshape();
  force_reshape_ = value;
  // @@protoc_insertion_point(field_set:caffe.LayerParameter.force_reshape)
}
...
inline const ::caffe::HungarianLossParameter& LayerParameter::hungarian_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.hungarian_loss_param)
...
inline ::caffe::HungarianLossParameter* LayerParameter::mutable_hungarian_loss_param() {
  ...
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.hungarian_loss_param)
...
inline void LayerParameter::set_allocated_hungarian_loss_param(::caffe::HungarianLossParameter* hungarian_loss_param) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.hungarian_loss_param)
}
...
// optional .caffe.PyParameter py_param = 203;
inline bool LayerParameter::has_py_param() const {
  return (_has_bits_[1] & 0x00000100u) != 0;
}
inline void LayerParameter::set_has_py_param() {
  _has_bits_[1] |= 0x00000100u;
}
inline void LayerParameter::clear_has_py_param() {
  _has_bits_[1] &= ~0x00000100u;
}
inline void LayerParameter::clear_py_param() {
  if (py_param_ != NULL) py_param_->::caffe::PyParameter::Clear();
  clear_has_py_param();
}
inline const ::caffe::PyParameter& LayerParameter::py_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.py_param)
  return py_param_ != NULL ? *py_param_ : *default_instance_->py_param_;
}
inline ::caffe::PyParameter* LayerParameter::mutable_py_param() {
  set_has_py_param();
  if (py_param_ == NULL) py_param_ = new ::caffe::PyParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.py_param)
  return py_param_;
}
inline ::caffe::PyParameter* LayerParameter::release_py_param() {
  clear_has_py_param();
  ::caffe::PyParameter* temp = py_param_;
  py_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_py_param(::caffe::PyParameter* py_param) {
  delete py_param_;
  py_param_ = py_param;
  if (py_param) {
    set_has_py_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.py_param)
}
...
// optional .caffe.WordvecParameter wordvec_param = 202;
inline bool LayerParameter::has_wordvec_param() const {
  return (_has_bits_[1] & 0x00100000u) != 0;
}
inline void LayerParameter::set_has_wordvec_param() {
  _has_bits_[1] |= 0x00100000u;
}
inline void LayerParameter::clear_has_wordvec_param() {
  _has_bits_[1] &= ~0x00100000u;
}
inline void LayerParameter::clear_wordvec_param() {
  if (wordvec_param_ != NULL) wordvec_param_->::caffe::WordvecParameter::Clear();
  clear_has_wordvec_param();
}
inline const ::caffe::WordvecParameter& LayerParameter::wordvec_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.wordvec_param)
  return wordvec_param_ != NULL ? *wordvec_param_ : *default_instance_->wordvec_param_;
}
inline ::caffe::WordvecParameter* LayerParameter::mutable_wordvec_param() {
  set_has_wordvec_param();
  if (wordvec_param_ == NULL) wordvec_param_ = new ::caffe::WordvecParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.wordvec_param)
  return wordvec_param_;
}
inline ::caffe::WordvecParameter* LayerParameter::release_wordvec_param() {
  clear_has_wordvec_param();
  ::caffe::WordvecParameter* temp = wordvec_param_;
  wordvec_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_wordvec_param(::caffe::WordvecParameter* wordvec_param) {
  delete wordvec_param_;
  wordvec_param_ = wordvec_param;
  if (wordvec_param) {
    set_has_wordvec_param();
  } else {
    clear_has_wordvec_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.wordvec_param)
}
...
// optional .caffe.NumpyDataParameter numpy_data_param = 1;
inline bool RuntimeParameter::has_numpy_data_param() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void RuntimeParameter::set_has_numpy_data_param() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RuntimeParameter::clear_has_numpy_data_param() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void RuntimeParameter::clear_numpy_data_param() {
  if (numpy_data_param_ != NULL) numpy_data_param_->::caffe::NumpyDataParameter::Clear();
  clear_has_numpy_data_param();
}
inline const ::caffe::NumpyDataParameter& RuntimeParameter::numpy_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.RuntimeParameter.numpy_data_param)
  return numpy_data_param_ != NULL ? *numpy_data_param_ : *default_instance_->numpy_data_param_;
}
inline ::caffe::NumpyDataParameter* RuntimeParameter::mutable_numpy_data_param() {
  set_has_numpy_data_param();
  if (numpy_data_param_ == NULL) numpy_data_param_ = new ::caffe::NumpyDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.RuntimeParameter.numpy_data_param)
  return numpy_data_param_;
}
inline ::caffe::NumpyDataParameter* RuntimeParameter::release_numpy_data_param() {
  clear_has_numpy_data_param();
  ::caffe::NumpyDataParameter* temp = numpy_data_param_;
  numpy_data_param_ = NULL;
  return temp;
}
inline void RuntimeParameter::set_allocated_numpy_data_param(::caffe::NumpyDataParameter* numpy_data_param) {
  delete numpy_data_param_;
  numpy_data_param_ = numpy_data_param;
  if (numpy_data_param) {
    set_has_numpy_data_param();
  } else {
    clear_has_numpy_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.RuntimeParameter.numpy_data_param)
}

// optional .caffe.CapSequenceParameter cap_sequence_param = 2;
inline bool RuntimeParameter::has_cap_sequence_param() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void RuntimeParameter::set_has_cap_sequence_param() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RuntimeParameter::clear_has_cap_sequence_param() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void RuntimeParameter::clear_cap_sequence_param() {
  if (cap_sequence_param_ != NULL) cap_sequence_param_->::caffe::CapSequenceParameter::Clear();
  clear_has_cap_sequence_param();
}
inline const ::caffe::CapSequenceParameter& RuntimeParameter::cap_sequence_param() const {
  // @@protoc_insertion_point(field_get:caffe.RuntimeParameter.cap_sequence_param)
  return cap_sequence_param_ != NULL ? *cap_sequence_param_ : *default_instance_->cap_sequence_param_;
}
inline ::caffe::CapSequenceParameter* RuntimeParameter::mutable_cap_sequence_param() {
  set_has_cap_sequence_param();
  if (cap_sequence_param_ == NULL) cap_sequence_param_ = new ::caffe::CapSequenceParameter;
  // @@protoc_insertion_point(field_mutable:caffe.RuntimeParameter.cap_sequence_param)
  return cap_sequence_param_;
}
inline ::caffe::CapSequenceParameter* RuntimeParameter::release_cap_sequence_param() {
  clear_has_cap_sequence_param();
  ::caffe::CapSequenceParameter* temp = cap_sequence_param_;
  cap_sequence_param_ = NULL;
  return temp;
}
inline void RuntimeParameter::set_allocated_cap_sequence_param(::caffe::CapSequenceParameter* cap_sequence_param) {
  delete cap_sequence_param_;
  cap_sequence_param_ = cap_sequence_param;
  if (cap_sequence_param) {
    set_has_cap_sequence_param();
  } else {
    clear_has_cap_sequence_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.RuntimeParameter.cap_sequence_param)
}
...
// optional bool fast_lstm_concat = 3 [default = false];
inline bool ConcatParameter::has_fast_lstm_concat() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ConcatParameter::set_has_fast_lstm_concat() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ConcatParameter::clear_has_fast_lstm_concat() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ConcatParameter::clear_fast_lstm_concat() {
  fast_lstm_concat_ = false;
  clear_has_fast_lstm_concat();
}
inline bool ConcatParameter::fast_lstm_concat() const {
  // @@protoc_insertion_point(field_get:caffe.ConcatParameter.fast_lstm_concat)
  return fast_lstm_concat_;
}
inline void ConcatParameter::set_fast_lstm_concat(bool value) {
  set_has_fast_lstm_concat();
  fast_lstm_concat_ = value;
  // @@protoc_insertion_point(field_set:caffe.ConcatParameter.fast_lstm_concat)
}
...
// optional uint32 num_cells = 1;
inline bool LstmParameter::has_num_cells() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void LstmParameter::set_has_num_cells() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LstmParameter::clear_has_num_cells() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LstmParameter::clear_num_cells() {
  num_cells_ = 0u;
  clear_has_num_cells();
}
inline ::google::protobuf::uint32 LstmParameter::num_cells() const {
  // @@protoc_insertion_point(field_get:caffe.LstmParameter.num_cells)
  return num_cells_;
}
inline void LstmParameter::set_num_cells(::google::protobuf::uint32 value) {
  set_has_num_cells();
  num_cells_ = value;
  // @@protoc_insertion_point(field_set:caffe.LstmParameter.num_cells)
}

// optional .caffe.FillerParameter input_weight_filler = 2;
inline bool LstmParameter::has_input_weight_filler() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void LstmParameter::set_has_input_weight_filler() {
  _has_bits_[0] |= 0x00000002u;
}
inline void LstmParameter::clear_has_input_weight_filler() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void LstmParameter::clear_input_weight_filler() {
  if (input_weight_filler_ != NULL) input_weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_input_weight_filler();
}
inline const ::caffe::FillerParameter& LstmParameter::input_weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LstmParameter.input_weight_filler)
  return input_weight_filler_ != NULL ? *input_weight_filler_ : *default_instance_->input_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::mutable_input_weight_filler() {
  set_has_input_weight_filler();
  if (input_weight_filler_ == NULL) input_weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LstmParameter.input_weight_filler)
  return input_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::release_input_weight_filler() {
  clear_has_input_weight_filler();
  ::caffe::FillerParameter* temp = input_weight_filler_;
  input_weight_filler_ = NULL;
  return temp;
}
inline void LstmParameter::set_allocated_input_weight_filler(::caffe::FillerParameter* input_weight_filler) {
  delete input_weight_filler_;
  input_weight_filler_ = input_weight_filler;
  if (input_weight_filler) {
    set_has_input_weight_filler();
  } else {
    clear_has_input_weight_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LstmParameter.input_weight_filler)
}

// optional .caffe.FillerParameter input_gate_weight_filler = 3;
inline bool LstmParameter::has_input_gate_weight_filler() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void LstmParameter::set_has_input_gate_weight_filler() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LstmParameter::clear_has_input_gate_weight_filler() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void LstmParameter::clear_input_gate_weight_filler() {
  if (input_gate_weight_filler_ != NULL) input_gate_weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_input_gate_weight_filler();
}
inline const ::caffe::FillerParameter& LstmParameter::input_gate_weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LstmParameter.input_gate_weight_filler)
  return input_gate_weight_filler_ != NULL ? *input_gate_weight_filler_ : *default_instance_->input_gate_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::mutable_input_gate_weight_filler() {
  set_has_input_gate_weight_filler();
  if (input_gate_weight_filler_ == NULL) input_gate_weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LstmParameter.input_gate_weight_filler)
  return input_gate_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::release_input_gate_weight_filler() {
  clear_has_input_gate_weight_filler();
  ::caffe::FillerParameter* temp = input_gate_weight_filler_;
  input_gate_weight_filler_ = NULL;
  return temp;
}
inline void LstmParameter::set_allocated_input_gate_weight_filler(::caffe::FillerParameter* input_gate_weight_filler) {
  delete input_gate_weight_filler_;
  input_gate_weight_filler_ = input_gate_weight_filler;
  if (input_gate_weight_filler) {
    set_has_input_gate_weight_filler();
  } else {
    clear_has_input_gate_weight_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LstmParameter.input_gate_weight_filler)
}

// optional .caffe.FillerParameter forget_gate_weight_filler = 4;
inline bool LstmParameter::has_forget_gate_weight_filler() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void LstmParameter::set_has_forget_gate_weight_filler() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LstmParameter::clear_has_forget_gate_weight_filler() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LstmParameter::clear_forget_gate_weight_filler() {
  if (forget_gate_weight_filler_ != NULL) forget_gate_weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_forget_gate_weight_filler();
}
inline const ::caffe::FillerParameter& LstmParameter::forget_gate_weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LstmParameter.forget_gate_weight_filler)
  return forget_gate_weight_filler_ != NULL ? *forget_gate_weight_filler_ : *default_instance_->forget_gate_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::mutable_forget_gate_weight_filler() {
  set_has_forget_gate_weight_filler();
  if (forget_gate_weight_filler_ == NULL) forget_gate_weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LstmParameter.forget_gate_weight_filler)
  return forget_gate_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::release_forget_gate_weight_filler() {
  clear_has_forget_gate_weight_filler();
  ::caffe::FillerParameter* temp = forget_gate_weight_filler_;
  forget_gate_weight_filler_ = NULL;
  return temp;
}
inline void LstmParameter::set_allocated_forget_gate_weight_filler(::caffe::FillerParameter* forget_gate_weight_filler) {
  delete forget_gate_weight_filler_;
  forget_gate_weight_filler_ = forget_gate_weight_filler;
  if (forget_gate_weight_filler) {
    set_has_forget_gate_weight_filler();
  } else {
    clear_has_forget_gate_weight_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LstmParameter.forget_gate_weight_filler)
}

// optional .caffe.FillerParameter output_gate_weight_filler = 5;
inline bool LstmParameter::has_output_gate_weight_filler() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LstmParameter::set_has_output_gate_weight_filler() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LstmParameter::clear_has_output_gate_weight_filler() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LstmParameter::clear_output_gate_weight_filler() {
  if (output_gate_weight_filler_ != NULL) output_gate_weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_output_gate_weight_filler();
}
inline const ::caffe::FillerParameter& LstmParameter::output_gate_weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LstmParameter.output_gate_weight_filler)
  return output_gate_weight_filler_ != NULL ? *output_gate_weight_filler_ : *default_instance_->output_gate_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::mutable_output_gate_weight_filler() {
  set_has_output_gate_weight_filler();
  if (output_gate_weight_filler_ == NULL) output_gate_weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LstmParameter.output_gate_weight_filler)
  return output_gate_weight_filler_;
}
inline ::caffe::FillerParameter* LstmParameter::release_output_gate_weight_filler() {
  clear_has_output_gate_weight_filler();
  ::caffe::FillerParameter* temp = output_gate_weight_filler_;
  output_gate_weight_filler_ = NULL;
  return temp;
}
inline void LstmParameter::set_allocated_output_gate_weight_filler(::caffe::FillerParameter* output_gate_weight_filler) {
  delete output_gate_weight_filler_;
  output_gate_weight_filler_ = output_gate_weight_filler;
  if (output_gate_weight_filler) {
    set_has_output_gate_weight_filler();
  } else {
    clear_has_output_gate_weight_filler();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LstmParameter.output_gate_weight_filler)
}
...
// repeated uint32 shape = 1;
inline int NumpyDataParameter::shape_size() const {
  return shape_.size();
}
inline void NumpyDataParameter::clear_shape() {
  shape_.Clear();
}
inline ::google::protobuf::uint32 NumpyDataParameter::shape(int index) const {
  // @@protoc_insertion_point(field_get:caffe.NumpyDataParameter.shape)
  return shape_.Get(index);
}
inline void NumpyDataParameter::set_shape(int index, ::google::protobuf::uint32 value) {
  shape_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.NumpyDataParameter.shape)
}
inline void NumpyDataParameter::add_shape(::google::protobuf::uint32 value) {
  shape_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.NumpyDataParameter.shape)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
NumpyDataParameter::shape() const {
  // @@protoc_insertion_point(field_list:caffe.NumpyDataParameter.shape)
  return shape_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
NumpyDataParameter::mutable_shape() {
  // @@protoc_insertion_point(field_mutable_list:caffe.NumpyDataParameter.shape)
  return &shape_;
}

// repeated float data = 2;
inline int NumpyDataParameter::data_size() const {
  return data_.size();
}
inline void NumpyDataParameter::clear_data() {
  data_.Clear();
}
inline float NumpyDataParameter::data(int index) const {
  // @@protoc_insertion_point(field_get:caffe.NumpyDataParameter.data)
  return data_.Get(index);
}
inline void NumpyDataParameter::set_data(int index, float value) {
  data_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.NumpyDataParameter.data)
}
inline void NumpyDataParameter::add_data(float value) {
  data_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.NumpyDataParameter.data)
}
inline const ::google::protobuf::RepeatedField< float >&
NumpyDataParameter::data() const {
  // @@protoc_insertion_point(field_list:caffe.NumpyDataParameter.data)
  return data_;
}
inline ::google::protobuf::RepeatedField< float >*
NumpyDataParameter::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:caffe.NumpyDataParameter.data)
  return &data_;
}
...
// repeated uint32 sequence_lengths = 1;
inline int CapSequenceParameter::sequence_lengths_size() const {
  return sequence_lengths_.size();
}
inline void CapSequenceParameter::clear_sequence_lengths() {
  sequence_lengths_.Clear();
}
inline ::google::protobuf::uint32 CapSequenceParameter::sequence_lengths(int index) const {
  // @@protoc_insertion_point(field_get:caffe.CapSequenceParameter.sequence_lengths)
  return sequence_lengths_.Get(index);
}
inline void CapSequenceParameter::set_sequence_lengths(int index, ::google::protobuf::uint32 value) {
  sequence_lengths_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.CapSequenceParameter.sequence_lengths)
}
inline void CapSequenceParameter::add_sequence_lengths(::google::protobuf::uint32 value) {
  sequence_lengths_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.CapSequenceParameter.sequence_lengths)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
CapSequenceParameter::sequence_lengths() const {
  // @@protoc_insertion_point(field_list:caffe.CapSequenceParameter.sequence_lengths)
  return sequence_lengths_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
CapSequenceParameter::mutable_sequence_lengths() {
  // @@protoc_insertion_point(field_mutable_list:caffe.CapSequenceParameter.sequence_lengths)
  return &sequence_lengths_;
}
...
// optional uint32 dimension = 1;
inline bool WordvecParameter::has_dimension() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void WordvecParameter::set_has_dimension() {
  _has_bits_[0] |= 0x00000001u;
}
inline void WordvecParameter::clear_has_dimension() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void WordvecParameter::clear_dimension() {
  dimension_ = 0u;
  clear_has_dimension();
}
inline ::google::protobuf::uint32 WordvecParameter::dimension() const {
  // @@protoc_insertion_point(field_get:caffe.WordvecParameter.dimension)
  return dimension_;
}
inline void WordvecParameter::set_dimension(::google::protobuf::uint32 value) {
  set_has_dimension();
  dimension_ = value;
  // @@protoc_insertion_point(field_set:caffe.WordvecParameter.dimension)
}

// optional uint32 vocab_size = 2;
inline bool WordvecParameter::has_vocab_size() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void WordvecParameter::set_has_vocab_size() {
  _has_bits_[0] |= 0x00000002u;
}
inline void WordvecParameter::clear_has_vocab_size() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void WordvecParameter::clear_vocab_size() {
  vocab_size_ = 0u;
  clear_has_vocab_size();
}
inline ::google::protobuf::uint32 WordvecParameter::vocab_size() const {
  // @@protoc_insertion_point(field_get:caffe.WordvecParameter.vocab_size)
  return vocab_size_;
}
inline void WordvecParameter::set_vocab_size(::google::protobuf::uint32 value) {
  set_has_vocab_size();
  vocab_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.WordvecParameter.vocab_size)
}

// optional .caffe.FillerParameter weight_filler = 3;
inline bool WordvecParameter::has_weight_filler() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void WordvecParameter::set_has_weight_filler() {
  _has_bits_[0] |= 0x00000004u;
}
inline void WordvecParameter::clear_has_weight_filler() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void WordvecParameter::clear_weight_filler() {
  if (weight_filler_ != NULL) weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_weight_filler();
}
inline const ::caffe::FillerParameter& WordvecParameter::weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.WordvecParameter.weight_filler)
  return weight_filler_ != NULL ? *weight_filler_ : *default_instance_->weight_filler_;
}
inline ::caffe::FillerParameter* WordvecParameter::mutable_weight_filler() {
  set_has_weight_filler();
  if (weight_filler_ == NULL) weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.WordvecParameter.weight_filler)
  return weight_filler_;
}
inline ::caffe::FillerParameter* WordvecParameter::release_weight_filler() {
  clear_has_weight_filler();
  ::caffe::FillerParameter* temp = weight_filler_;
  weight_filler_ = NULL;
  return temp;
}
inline void WordvecParameter::set_allocated_weight_filler(::caffe::FillerParameter* weight_filler) {
  delete weight_filler_;
  weight_filler_ = weight_filler;
  if (weight_filler) {
    set_has_weight_filler();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.WordvecParameter.weight_filler)
}
...
inline float HungarianLossParameter::match_ratio() const {
  // @@protoc_insertion_point(field_get:caffe.HungarianLossParameter.match_ratio)
  return match_ratio_;
}
inline void HungarianLossParameter::set_match_ratio(float value) {
  set_has_match_ratio();
  match_ratio_ = value;
  // @@protoc_insertion_point(field_set:caffe.HungarianLossParameter.match_ratio)
}
...
inline bool HungarianLossParameter::permute_matches() const {
  // @@protoc_insertion_point(field_get:caffe.HungarianLossParameter.permute_matches)
...
inline void HungarianLossParameter::set_permute_matches(bool value) {
  ...
  // @@protoc_insertion_point(field_set:caffe.HungarianLossParameter.permute_matches)
}
...
// optional bool output_4d = 6 [default = false];
inline bool InnerProductParameter::has_output_4d() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void InnerProductParameter::set_has_output_4d() {
  _has_bits_[0] |= 0x00000020u;
}
inline void InnerProductParameter::clear_has_output_4d() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void InnerProductParameter::clear_output_4d() {
  output_4d_ = false;
  clear_has_output_4d();
}
inline bool InnerProductParameter::output_4d() const {
  // @@protoc_insertion_point(field_get:caffe.InnerProductParameter.output_4d)
  return output_4d_;
}
inline void InnerProductParameter::set_output_4d(bool value) {
  set_has_output_4d();
  output_4d_ = value;
  // @@protoc_insertion_point(field_set:caffe.InnerProductParameter.output_4d)
}
...
// repeated int32 dimension = 1;
inline int ParamShapeParameter::dimension_size() const {
  return dimension_.size();
}
inline void ParamShapeParameter::clear_dimension() {
  dimension_.Clear();
}
inline ::google::protobuf::int32 ParamShapeParameter::dimension(int index) const {
  // @@protoc_insertion_point(field_get:caffe.ParamShapeParameter.dimension)
  return dimension_.Get(index);
}
inline void ParamShapeParameter::set_dimension(int index, ::google::protobuf::int32 value) {
  dimension_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.ParamShapeParameter.dimension)
}
inline void ParamShapeParameter::add_dimension(::google::protobuf::int32 value) {
  dimension_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.ParamShapeParameter.dimension)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
ParamShapeParameter::dimension() const {
  // @@protoc_insertion_point(field_list:caffe.ParamShapeParameter.dimension)
  return dimension_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
ParamShapeParameter::mutable_dimension() {
  // @@protoc_insertion_point(field_mutable_list:caffe.ParamShapeParameter.dimension)
  return &dimension_;
}
...
// repeated .caffe.ParamShapeParameter param_shapes = 1;
inline int PyParameter::param_shapes_size() const {
  return param_shapes_.size();
}
inline void PyParameter::clear_param_shapes() {
  param_shapes_.Clear();
}
inline const ::caffe::ParamShapeParameter& PyParameter::param_shapes(int index) const {
  // @@protoc_insertion_point(field_get:caffe.PyParameter.param_shapes)
  return param_shapes_.Get(index);
}
inline ::caffe::ParamShapeParameter* PyParameter::mutable_param_shapes(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.PyParameter.param_shapes)
  return param_shapes_.Mutable(index);
}
inline ::caffe::ParamShapeParameter* PyParameter::add_param_shapes() {
  // @@protoc_insertion_point(field_add:caffe.PyParameter.param_shapes)
  return param_shapes_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::ParamShapeParameter >&
PyParameter::param_shapes() const {
  // @@protoc_insertion_point(field_list:caffe.PyParameter.param_shapes)
  return param_shapes_;
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::ParamShapeParameter >*
PyParameter::mutable_param_shapes() {
  // @@protoc_insertion_point(field_mutable_list:caffe.PyParameter.param_shapes)
  return &param_shapes_;
}

// repeated .caffe.FillerParameter param_fillers = 2;
inline int PyParameter::param_fillers_size() const {
  return param_fillers_.size();
}
inline void PyParameter::clear_param_fillers() {
  param_fillers_.Clear();
}
inline const ::caffe::FillerParameter& PyParameter::param_fillers(int index) const {
  // @@protoc_insertion_point(field_get:caffe.PyParameter.param_fillers)
  return param_fillers_.Get(index);
}
inline ::caffe::FillerParameter* PyParameter::mutable_param_fillers(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.PyParameter.param_fillers)
  return param_fillers_.Mutable(index);
}
inline ::caffe::FillerParameter* PyParameter::add_param_fillers() {
  // @@protoc_insertion_point(field_add:caffe.PyParameter.param_fillers)
  return param_fillers_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::FillerParameter >&
PyParameter::param_fillers() const {
  // @@protoc_insertion_point(field_list:caffe.PyParameter.param_fillers)
  return param_fillers_;
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::FillerParameter >*
PyParameter::mutable_param_fillers() {
  // @@protoc_insertion_point(field_mutable_list:caffe.PyParameter.param_fillers)
  return &param_fillers_;
}
...
// optional bool fast_wordvec_slice = 4 [default = false];
inline bool SliceParameter::has_fast_wordvec_slice() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void SliceParameter::set_has_fast_wordvec_slice() {
  _has_bits_[0] |= 0x00000004u;
}
inline void SliceParameter::clear_has_fast_wordvec_slice() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void SliceParameter::clear_fast_wordvec_slice() {
  fast_wordvec_slice_ = false;
  clear_has_fast_wordvec_slice();
}
inline bool SliceParameter::fast_wordvec_slice() const {
  // @@protoc_insertion_point(field_get:caffe.SliceParameter.fast_wordvec_slice)
  return fast_wordvec_slice_;
}
inline void SliceParameter::set_fast_wordvec_slice(bool value) {
  set_has_fast_wordvec_slice();
  fast_wordvec_slice_ = value;
  // @@protoc_insertion_point(field_set:caffe.SliceParameter.fast_wordvec_slice)
}
